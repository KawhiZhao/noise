...
def mix_two_audio(count, phrase='train', return_separated_audio=False):
    ...
    for i in (range(count)):
        ...
        doa1, delta_x_norm, delta_y_norm = calculate_DoA_norm(speaker_x, speaker_y, center_x, center_y)
        ...
        mixed_audio = room.mic_array.signals
        mixed_audio = mixed_audio[:, :len_audio]
        
        if return_separated_audio:
            return audio1, audio2, mixed_audio, doa1, caption1, caption2

        return mixed_audio, doa1, caption1, delta_x_norm, delta_y_norm
        # room.mic_array.to_wav(
        #     f"/mnt/fast/nobackup/scratch4weeks/jz01019/AAC/tmp_test/" + wav_name,
        #     norm=True,
        #     bitdepth=np.int16,
        # )
