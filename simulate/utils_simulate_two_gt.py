...
def mix_two_audio(count, phrase='train'):
    ...
    for i in range(count):
        ...
        # folder_name = os.path.join('/mnt/fast/nobackup/scratch4weeks/jz01019/AAC/tmp_two_gt_val/', folder_name)
        # if not os.path.exists(folder_name):
        #     os.mkdir(folder_name)
        
        mixed_audio = room.mic_array.signals
        mixed_audio = mixed_audio[:, :len_audio]
        return mixed_audio, doa1, doa2, caption1, caption2
        # room.mic_array.to_wav(
        #     os.path.join(folder_name, wav_name),
        #     norm=True,
        #     bitdepth=np.int16,
        # )
        ...
        # with open(os.path.join(folder_name, txt_name), 'w', encoding='utf-8') as f:
        #     f.write(caption1 + '\n')
        #     f.write(caption2 + '\n')
        #     f.write(str(doa1) + '\n')
        #     f.write(str(doa2) + '\n')
        #     f.write(str(len_audio) + '\n')
